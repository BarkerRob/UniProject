...
def main():
    ...
    for game_id, db_team_one, db_team_two, season, db_team_one_score, db_team_two_score in games:
        ...
        form_against_team = recent_form_against_team(team_one, team_two, game_id, db_cursor)
        if team_one_score > team_two_score:
            ...
            actual_result = 'DRAW'
        sql = f"INSERT INTO nv_test_data values (" \
    ...
    for game_id, db_team_one, db_team_two, season, db_team_one_score, db_team_two_score in games:
        ...
        if team_one_score > team_two_score:
            ...
            actual_result = 'DRAW'
        sql = f"INSERT INTO nv_data values (" \
              f"{distance_travelled_result}, " \
              f"{form_against_team}, " \
              f"'{actual_result}') "
        db_cursor.execute(sql)
...
def recent_form_against_team(team_id_one, team_id_two, game_id, db_cursor):
    sql = f'SELECT * ' \
          f'FROM plepa.game ' \
